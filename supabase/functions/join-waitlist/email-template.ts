...
export function buildEmail(
  ...
  const t = isEn
    ? {
        ...
        how: 'How you move up',
        w1: 'Wave 1 — First 100',
        w1s: 'Exclusive perks · Founding Member',
        w1b: '3 referrals ⚡',
        w2: 'Wave 2 — Next 150',
        ...
        urg2: '3 friends = exclusive perks, locked in.',
    ...
    : {
        ...
        w1s: 'Ventajas exclusivas · Founding Member',
        w1b: '3 referidos ⚡',
        ...
        urg2: '3 amigos = ventajas exclusivas aseguradas.',
