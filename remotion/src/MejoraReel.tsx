...
export const MEJORA_FPS = FPS;
export const MEJORA_DURATION = 602;
...
const SceneFactor: React.FC = () => (
  <Scene dur={182}>
    <div style={{ display: "flex", flexDirection: "column", gap: 52 }}>
      <Header badge="02" title="Mejora contigo" />
      <div style={{ fontFamily: FONT, fontWeight: 800, fontSize: 50, color: C.accent2 }}>
        Tu factor respuesta es ÚNICO.
      </div>
      <div style={{ display: "flex", gap: 44 }}>
        <Bar to={0.85} delay={40} label="Tu cuerpo · +10%/sem" strong />
        <Bar to={0.5} delay={54} label="Otro cuerpo · +5%/sem" />
      </div>
...
const SceneEvolve: React.FC = () => (
  <Scene dur={182}>
    <div style={{ display: "flex", flexDirection: "column", gap: 50 }}>
      <div>
        <Eyebrow>El plan evoluciona</Eyebrow>
        <BigTitle>Cada semana, más afinado.</BigTitle>
      </div>
      ...
      >
        <span style={{ fontFamily: FONT, fontWeight: 600, fontSize: 52, color: C.text }}>Carga ajustada</span>
  ...
  return (
    <div style={{ position: "relative", width: size, height: size }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        ...
        <span style={{ fontFamily: FONT, fontWeight: 700, fontSize: 44, color: C.sub }}>adherencia</span>
      </div>
    </div>
  );
};
...
const SceneAdherence: React.FC = () => (
  <Scene dur={170}>
    <div style={{ display: "flex", flexDirection: "column", gap: 56, alignItems: "flex-start" }}>
      <div>
        <Eyebrow>Constancia real</Eyebrow>
        <BigTitle>Y tú lo notas.</BigTitle>
      </div>
...
export const MejoraReel: React.FC = () => (
  <LoopWrap>
    <Sequence from={0} durationInFrames={96}>
      <Hook lines={["No hay dos", "cuerpos iguales."]} dur={96} />
    </Sequence>
